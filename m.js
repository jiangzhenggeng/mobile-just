...
;(function () {
    ...
    if(document.getElementsByTagName("head")[0].appendChild(style_obj),style_obj.styleSheet){
        style_obj.styleSheet.disabled||(style_obj.styleSheet.cssText=style_str);
    }else{
        try{
            style_obj.innerHTML=style_str;
        }catch(e){
            style_obj.innerText=style_str;
        }
    }
})();
